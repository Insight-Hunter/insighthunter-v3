...
export const ForecastScenarios = ({ scenarios, activeScenario, onSelectScenario }) => {
    ...
    return (<div className="forecast-scenarios">
      <h3 className="scenarios-title">Scenarios</h3>
      <div className="scenarios-grid">
        {scenarios.map((scenario) => (<button key={scenario.type} className={`scenario-card ${activeScenario === scenario.type ? 'active' : ''}`} onClick={() => onSelectScenario(scenario.type)} style={{
            ...
            <div className="scenario-header">
              ...
              <span className="scenario-indicator" style={{ backgroundColor: getScenarioColor(scenario.type) }}/>
            </div>
