...
import {
  TrendingUp, TrendingDown, Target, AlertCircle, Zap, RefreshCw,
} from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            ...
            <div
              className={`text-sm ${
                currentForecast.trend === 'increasing' ? 'text-green-600' : 'text-red-600'
              }`}
            >
        ...
        {/* Insights section */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {insights.map(({ type, title, description, icon: Icon, color }) => (
            <div
              key={title}
              className={`flex items-center gap-4 p-4 rounded-lg border ${
                type === 'positive' ? 'border-green-200' : 'border-yellow-200'
              } bg-white shadow-sm`}
            >
