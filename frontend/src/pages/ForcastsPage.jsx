...
import { TrendingUp, TrendingDown, Target, AlertCircle, Zap, Calendar, RefreshCw } from ‘lucide-react’;
...
{ month: ‘Q4’, pattern: ‘Peak Season’, impact: ‘+25%’, color: ‘bg-green-100 text-green-700’ },
{ month: ‘Q1’, pattern: ‘Slow Period’, impact: ‘-12%’, color: ‘bg-orange-100 text-orange-700’ },
{ month: ‘Summer’, pattern: ‘Moderate’, impact: ‘-8%’, color: ‘bg-yellow-100 text-yellow-700’ }
];
    ...
    <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-200">
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="flex gap-2">
          {['revenue', 'expenses', 'profit'].map((type) => (
            <button
              key={type}
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
        <div className="flex items-center justify-between mb-2">
          ...
          {currentForecast.trend === 'increasing' ? (
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
        ...
        <div className="text-3xl font-bold text-gray-900 mb-2">
          +{currentForecast.growth}%
        </div>
        <div className="text-sm text-gray-600">
          Next quarter vs current
        </div>
      </div>
    </div>
