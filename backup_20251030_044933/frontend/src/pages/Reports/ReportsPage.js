...
import { FileText, Download, Eye, Calendar, Filter, Plus, TrendingUp, DollarSign, PieChart, BarChart3 } from 'lucide-react';
    ...
    return (<div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {reportTypes.map(type => (<button key={type.id} onClick={() => setSelectedType(type.id)} className={`bg-white rounded-lg shadow-sm p-6 border-2 transition-all hover:shadow-md ${selectedType === type.id ? 'border-blue-500' : 'border-gray-200'}`}>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-200">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <select value={selectedType} onChange={e => setSelectedType(e.target.value)} className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            ...
            <select value={selectedClient} onChange={e => setSelectedClient(e.target.value)} className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            ...
            {(selectedType !== 'all' || selectedClient !== 'all') && (<button onClick={() => {
                setSelectedType('all');
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="divide-y divide-gray-200">
            ...
            return (<div key={report.id} className="p-6 hover:bg-gray-50 transition-colors flex items-start justify-between">
                    ...
                    <div className="flex items-center gap-2 ml-4">
                      {report.status === 'processing' ? (<span className="px-3 py-1 bg-orange-100 text-orange-800 rounded-full text-xs font-medium flex items-center gap-2">
