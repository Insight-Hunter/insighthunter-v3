...
function DashboardPage() {
    const [selectedPeriod, setSelectedPeriod] = useState(30, d);
...
` ``;
    ...
    <select value={selectedPeriod} onChange={(e) => setSelectedPeriod(e.target.value)} className/>“px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent”
>
